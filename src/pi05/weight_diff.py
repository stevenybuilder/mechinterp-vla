...
def sd(snap):
    ...
    return out
base=sd(os.environ.get("HF_HUB", "~/.cache/huggingface/hub") + "/models--lerobot--pi05_base/snapshots/b211f3d44c36b6acfcf7ae94a64e8e96f75a64ba")
ft=sd(os.environ.get("HF_HUB", "~/.cache/huggingface/hub") + "/models--lerobot--pi05_libero_finetuned_v044/snapshots/8e174154ef5f6c60a8da12ae99c303d8963138c1")
...
json.dump({"n_shared_keys":len(keys),"missing":missing,"summary_by_half_part":summary,"summary_by_layer":summary_by_layer,"per_tensor":rows},open("artifacts/vla_diffing/weight_diff.json","w"),indent=1)
