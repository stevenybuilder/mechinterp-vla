...
| Is it a small localized patch? | Local carrier was B-like in 0/8 eligible directions (`D_B=0.99450`). In the dose test, pooled descriptive median repair `R` was `0.04336` at 128 selected positions, `0.08186` at 256 selected, `0.18020` at 256 random, and `0.77325` at all 512. Cell-aware medians were `0.03943`, `0.07834`, `0.18020`, and `0.77308`. | run2 and `artifacts/pi05_mediation_2026-08-31/dose1/rows.jsonl` | No small spatial/token subset carried the effect under this test. The signal behaves like a field over the image-position state. |
